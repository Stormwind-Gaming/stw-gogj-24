...
var breakpoints = [
	float(Constants.GLOBAL_SYMPATHY_BREAKPOINT_LOW) / Constants.RESISTANCE_ENDGAME_THRESHOLD,
	float(Constants.GLOBAL_SYMPATHY_BREAKPOINT_MEDIUM) / Constants.RESISTANCE_ENDGAME_THRESHOLD,
	float(Constants.GLOBAL_SYMPATHY_BREAKPOINT_HIGH) / Constants.RESISTANCE_ENDGAME_THRESHOLD
] 
