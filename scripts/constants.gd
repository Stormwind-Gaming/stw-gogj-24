...
"""
var HEAT_ENDGAME_THRESHOLD: int = 10
...
"""
# +10% injury risk
var INDUSTRIAL_DISTRICT_MODIFIER_BASE: float = 1.1
# const INDUSTRIAL_DISTRICT_MODIFIER_STAT: injury

"""
@brief positive effect gained from industry district when over 66 percent sympathy
"""
var INDUSTRIAL_DISTRICT_MODIFIER_HIGH_SYMPATHY_VALUE: int = 1
var INDUSTRIAL_DISTRICT_MODIFIER_HIGH_SYMPATHY_STAT: Enums.StatCheckType = Enums.StatCheckType.SMARTS

var INDUSTRIAL_DISTRICT_BONUS_BREAKPOINT: int = 66
...
func _on_constants_loaded():
	...
	INDUSTRIAL_DISTRICT_MODIFIER_BASE = config.get_value("INDUSTRIAL_DISTRICT_MODIFIER_BASE", INDUSTRIAL_DISTRICT_MODIFIER_BASE)
	INDUSTRIAL_DISTRICT_MODIFIER_HIGH_SYMPATHY_VALUE = config.get_value("INDUSTRIAL_DISTRICT_MODIFIER_HIGH_SYMPATHY_VALUE", INDUSTRIAL_DISTRICT_MODIFIER_HIGH_SYMPATHY_VALUE)
	...
	INDUSTRIAL_DISTRICT_BONUS_BREAKPOINT = config.get_value("INDUSTRIAL_DISTRICT_BONUS_BREAKPOINT", INDUSTRIAL_DISTRICT_BONUS_BREAKPOINT)
